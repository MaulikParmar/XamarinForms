...
namespace ValidationDemo.Layouts
{
    ...
    public class WrapLayout : Layout<View>
    {
        ...
        public static readonly BindableProperty ColumnSpacingProperty =
           BindableProperty.Create("ColumnSpacing", typeof(double), typeof(WrapLayout), defaultValue: 2.0,
               propertyChanged: (bindable, oldValue, newValue) =>
               {
                   ((WrapLayout)bindable).InvalidateLayout();
               });
        ...
        public static readonly BindableProperty RowSpacingProperty =
           BindableProperty.Create("RowSpacing", typeof(double), typeof(WrapLayout), defaultValue: 2.0,
                propertyChanged: (bindable, oldValue, newValue) =>
                {
                    ((WrapLayout)bindable).InvalidateLayout();
                });
